...
#include "mesh_loader/filesystem.h"
#include "mesh_loader/shader.h"
#include "mesh_loader/camera.h"
#include "mesh_loader/model.h"
...
int main() {
    ...
    Model ourModel(FileSystem::getPath("models/3d/semantic.obj"));
